        ...
        <div className="Home">
            {
                data.map(item=>{
                    ...
                    <div className="card home-card input-field" key={item._id}>
                        ...
                        <h5 style={{padding:"6px"}}><img src={item.postedBy.pic} alt="" style={{height:"20px", width:"20px", borderRadius:"50%", marginRight:"5px"}} /><Link to={item.postedBy._id !== state._id? `/profile/${item.postedBy._id}`: '/profile' }>{item.postedBy.name}</Link>
                        {//Debería usar un thumbnail en lugar de la foto entera, para alivianar datos.
